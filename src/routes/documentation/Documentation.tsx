  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="center-div">
        <button className="btn" onClick={() => {setLanguage("java")}}>Show java</button>
        <button className="btn" onClick={() => {setLanguage("python")}}>Show python</button>
      </div>
      ...
      <div className="mockup-code">
        {(language === "python" ?
          <p>current_bot_hand_type = obs.get_my_hand_type()</p> :
          <p>HandType currentBotHandType = obs.getMyHandType();</p>
        )}
      </div>
      ...
      <div className="mockup-code">
        {(language === "python" ?
          <p>current_board_hand_type = obs.get_board_hand_type()</p> :
          <p>HandType currentBoardHandType = obs.getBoardHandType(); </p>
        )}
      </div>
...
<pre data-section="java"><code class="language-java">int myIndex = obs.getMyIndex();</code></pre>
      ...
      <br />
      <br />
      <h2>  mentation (Only in python)</h2>
      <hr>
